/*** Autogenerated by WIDL 7.7 from d3dcommon.idl - Do not edit ***/
...
/*** ID3D10Blob methods ***/
static FORCEINLINE LPVOID ID3D10Blob_GetBufferPointer(ID3D10Blob* This) {
...
/*** ID3DDestructionNotifier methods ***/
#define ID3DDestructionNotifier_RegisterDestructionCallback(This,callbackFn,pData,pCallbackID) (This)->lpVtbl->RegisterDestructionCallback(This,callbackFn,pData,pCallbackID)
#define ID3DDestructionNotifier_UnregisterDestructionCallback(This,callbackID) (This)->lpVtbl->UnregisterDestructionCallback(This,callbackID)
#else
/*** IUnknown methods ***/
...
/*** ID3DDestructionNotifier methods ***/
static FORCEINLINE HRESULT ID3DDestructionNotifier_RegisterDestructionCallback(ID3DDestructionNotifier* This,PFN_DESTRUCTION_CALLBACK callbackFn,void *pData,UINT *pCallbackID) {
    return This->lpVtbl->RegisterDestructionCallback(This,callbackFn,pData,pCallbackID);
}
static FORCEINLINE HRESULT ID3DDestructionNotifier_UnregisterDestructionCallback(ID3DDestructionNotifier* This,UINT callbackID) {
    return This->lpVtbl->UnregisterDestructionCallback(This,callbackID);
}
#endif
#endif
